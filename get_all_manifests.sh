...
declare -A ODH_COMPONENT_MANIFESTS=(
    ["dashboard"]="opendatahub-io:odh-dashboard:main@907a46a32bc6d51d870d67f03fbe12ab25fc8d87:manifests"
    ...
    ["workbenches/notebooks"]="opendatahub-io:notebooks:main@30f79d853473561099215a0ee095be3165bb663d:manifests"
    ["kserve"]="opendatahub-io:kserve:release-v0.17@9d8b33b2ec5b7156d1444016c7fc024ea0081596:config"
    ["ray"]="opendatahub-io:kuberay:dev@c9b4bd7563cdd0d01ea45594926e03d1e43952e6:ray-operator/config"
    ["trustyai"]="opendatahub-io:trustyai-service-operator:incubation@ab08a266fa03c42fedf0b3d192823a10e125f380:config"
    ...
    ["datasciencepipelines"]="opendatahub-io:data-science-pipelines-operator:main@21360c77fe20a57c152ff8765cb90bdcc8c7ff6a:config"
    ...
    ["mlflowoperator"]="opendatahub-io:mlflow-operator:main@f09904b69859b3d68fcd2dea57e766143909512f:config"
...
declare -A RHOAI_COMPONENT_MANIFESTS=(
    ["dashboard"]="red-hat-data-services:odh-dashboard:rhoai-3.5-ea.2@07c0acbaf06f743e1825c358c3f84f9769e74372:manifests"
    ["workbenches/kf-notebook-controller"]="red-hat-data-services:kubeflow:rhoai-3.5-ea.2@5dc71dd363b77153b0f0861ac951597258c28525:components/notebook-controller/config"
    ["workbenches/odh-notebook-controller"]="red-hat-data-services:kubeflow:rhoai-3.5-ea.2@5dc71dd363b77153b0f0861ac951597258c28525:components/odh-notebook-controller/config"
    ["workbenches/notebooks"]="red-hat-data-services:notebooks:rhoai-3.5-ea.2@a15f5837562b139854482038bb55ee67c135700f:manifests"
    ["kserve"]="red-hat-data-services:kserve:rhoai-3.5-ea.2@dd8e0ef9f42e3df6219d0a3ee7f598c3a43bfb6e:config"
    ["ray"]="red-hat-data-services:kuberay:rhoai-3.5-ea.2@bef08fd44257ce9244e0191c997a4e9f6894ad71:ray-operator/config"
    ["trustyai"]="red-hat-data-services:trustyai-service-operator:rhoai-3.5-ea.2@77e576894f0019576712839606be60466d911309:config"
    ["modelregistry"]="red-hat-data-services:model-registry-operator:rhoai-3.5-ea.2@70b702e1a08b5dba4b7c4fd63868b0dd9205d643:config"
    ["trainingoperator"]="red-hat-data-services:training-operator:rhoai-3.5-ea.2@a8ca6b930d14faf5e16eb50e4d4a36436ccc092e:manifests"
    ["datasciencepipelines"]="red-hat-data-services:data-science-pipelines-operator:rhoai-3.5-ea.2@9c33f752df05eeb9d7216513bc39e8955a8a65b3:config"
    ...
    ["feastoperator"]="red-hat-data-services:feast:rhoai-3.5-ea.2@a256809e600d698c9c7d816c0624c0f4b7063755:infra/feast-operator/config"
    ...
    ["maas"]="red-hat-data-services:maas-billing:rhoai-3.5-ea.2@59a3a0af78164af05b2b5a7be89d310264b46093:deployment"
    ["mlflowoperator"]="red-hat-data-services:mlflow-operator:rhoai-3.5-ea.2@b79ef416026a1d7b08a2423f557d6f0d7b17cadd:config"
    ["sparkoperator"]="red-hat-data-services:spark-operator:rhoai-3.5-ea.2@7eedf3c3779e2116b706798ae80f1987668f9cf1:config"
    ["wva"]="red-hat-data-services:workload-variant-autoscaler:rhoai-3.5-ea.2@8b506a6544c0c6b103450c7ece9c6176b13681fd:config"
